...
export default function Dashboard() {
	const { chart, recentInterventions, recentAbsences, stats, atRiskStudents } = usePage().props;
	...
	return (
		<AuthenticatedLayout header={<h2 className="text-2xl font-bold leading-tight text-gray-800">PedroHub Dashboard</h2>}>
