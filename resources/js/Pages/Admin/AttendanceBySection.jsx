...
export default function AttendanceBySection({ sections, students, filters }) {
	...
	return (
		<AuthenticatedLayout header={<h2 className="text-xl font-semibold leading-tight text-gray-800">Attendance by Section</h2>}>
				...
				<div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
					<div className="card mb-4">
						<form method="get">
							...
							<select name="section_id" defaultValue={filters.section_id || ''} className="rounded border px-2 py-1" onChange={(e) => e.currentTarget.form.submit()}>
