...
export default function ChangePasswordFirstTime() {
    ...
    const submit = (e) => {
        ...
        put(route('password.update.first-time'), {
            onError: (errors) => {
                if (errors.password) {
                    reset('password', 'password_confirmation');
                    ...
                    <div className="w-full max-w-lg">
                        ...
                        <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white p-10 shadow-xl md:p-12">
                            <div className="text-center mb-8">
                                ...
                                <h2 className="mb-3 text-4xl font-bold text-gray-900">Change Your Password</h2>
                                <p className="text-lg text-gray-600">For security reasons, please change your password before accessing the system</p>
                            </div>
                            ...
                            <form onSubmit={submit} className="space-y-6">
                                <div className="space-y-2">
                                    ...
                                    {errors.current_password && (
                                        <div className="mt-2 text-base text-red-600 font-medium">{errors.current_password}</div>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {errors.password && (
                                        <div className="mt-2 text-base text-red-600 font-medium">{errors.password}</div>
                                    )}
                                </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    {errors.password_confirmation && (
                                        <div className="mt-2 text-base text-red-600 font-medium">{errors.password_confirmation}</div>
                                    )}
                                </div>
